...
def build_chunk_analysis_prompt(chunk_text: str, reference_texts: List[Dict], context_prev: str = '', context_next: str = '', business_rules: List[Dict] = None) -> str:
    ...
    style_requirements = (
        ...
        "  ❌ Do NOT write: 'The closer built rapport in this chunk.'\n"
        "  ✅ Instead, write: 'Built rapport by sharing a personal story about overcoming similar challenges.'\n"
        "  ❌ Do NOT write: 'The closer did not address the lead’s concern about tracking her income.'\n"
        "  ✅ Instead, write: 'Missed an opportunity to address the lead’s concern about tracking income; could have suggested tools or advice.'\n"
        "- Information Gathered:\n"
        "  ❌ Do NOT write: 'The lead is interested in Amazon and has some experience selling on the platform.'\n"
        "  ✅ Instead, write: 'Demonstrated prior experience with Amazon, which could be leveraged to accelerate onboarding.'\n"
        "  ❌ Do NOT write: 'The lead wants time freedom and is concerned about product sourcing.'\n"
        "  ✅ Instead, write: 'Expressed a desire for time freedom and raised specific concerns about sourcing products efficiently.'\n"
        "- Reference Comparisons:\n"
        "  ❌ Do NOT write: 'This is similar to successful examples where the closer uses casual conversation to build rapport at the beginning of the call.'\n"
        "  ✅ Instead, write: 'Built rapport at the start of the call by discussing shared interests, mirroring successful approaches from top performers.'\n"
        "- Differences:\n"
        "  ❌ Do NOT write: 'In successful examples, the closer would address this concern by offering solutions or strategies for effective product sourcing.'\n"
        "  ✅ Instead, write: 'Missed an opportunity to address the lead’s concern about product sourcing; could have offered strategies such as X or Y, as seen in top calls.'\n"
        "- Coaching Recommendations:\n"
        "  ❌ Do NOT write: 'Should ask more discovery questions.'\n"
        "  ✅ Instead, write: 'Should have asked more about the lead’s previous business attempts to uncover challenges and tailor the solution.'\n"
