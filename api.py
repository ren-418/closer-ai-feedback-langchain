...
import uvicorn
from langchain.evaluator import SalesCallEvaluator
from embeddings.pinecone_store import PineconeManager
import json

app = FastAPI(
    title="AI Sales Call Evaluator API",
    description="API for evaluating sales calls using RAG and LLM analysis",
    version="1.0.0"
)
...
async def evaluate_transcript(request: TranscriptRequest):
    """
    Evaluate a sales call transcript and return detailed analysis.
    """
    try:
